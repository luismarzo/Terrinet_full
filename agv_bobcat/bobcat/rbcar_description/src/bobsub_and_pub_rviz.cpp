...
public:
  SubscribeAndPublish()
  {
    ...
    pub_ = n_.advertise<geometry_msgs::PoseStamped>("/bobcat/move_base_simple/goal", 1);
    pub_ini = n_.advertise<geometry_msgs::PoseWithCovarianceStamped>("/bobcat/initialpose", 1);
