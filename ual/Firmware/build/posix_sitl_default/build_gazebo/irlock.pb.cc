...
void protobuf_AddDesc_irlock_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014irlock.proto\022\020irlock_msgs.msgs\"l\n\006irlo"
...
irlock::irlock()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:irlock_msgs.msgs.irlock)
}
...
irlock::irlock(const irlock& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:irlock_msgs.msgs.irlock)
}
...
irlock::~irlock() {
  // @@protoc_insertion_point(destructor:irlock_msgs.msgs.irlock)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:irlock_msgs.msgs.irlock)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:irlock_msgs.msgs.irlock)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:irlock_msgs.msgs.irlock)
  return false;
#undef DO_
}
...
void irlock::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:irlock_msgs.msgs.irlock)
  // required float time_usec = 1;
  if (has_time_usec()) {
  ...
  // @@protoc_insertion_point(serialize_end:irlock_msgs.msgs.irlock)
}

::google::protobuf::uint8* irlock::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:irlock_msgs.msgs.irlock)
  // required float time_usec = 1;
  if (has_time_usec()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:irlock_msgs.msgs.irlock)
  return target;
}
